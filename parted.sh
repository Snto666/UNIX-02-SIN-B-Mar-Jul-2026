...
stat archivo.txt # Displays the entire file resume on a single screen, for example we can see te size of the document created, so we can identify how this works into the file